...
<html lang="en">
  ...
  <link rel="web-socket" href="wss://live.github.com/_sockets/VjI6MjcxMzE1ODIwOmMxNDViMWVhY2U3MDc0NDc5MWNhZGY4YmY1OTkzZTBlMzI2YTRhMmQ1YTNhY2ZlYTE1MmI1YzA1ZWNiMzkxZDg=--b43730de071cfd454529019754c18ffd03123f15">
  <meta name="pjax-timeout" content="1000">
  <link rel="sudo-modal" href="/sessions/sudo_modal">
  <meta name="request-id" content="5F59:2062:26F110C:3AAB8A0:5B0BD276" data-pjax-transient>
...
<meta name="octolytics-host" content="collector.githubapp.com" /><meta name="octolytics-app-id" content="github" /><meta name="octolytics-event-url" content="https://collector.githubapp.com/github-external/browser_event" /><meta name="octolytics-dimension-request_id" content="5F59:2062:26F110C:3AAB8A0:5B0BD276" /><meta name="octolytics-dimension-region_edge" content="sea" /><meta name="octolytics-dimension-region_render" content="iad" /><meta name="octolytics-actor-id" content="625367" /><meta name="octolytics-actor-login" content="oilenrock07" /><meta name="octolytics-actor-hash" content="c61432145ad8c605129c281b80116cb72ed8485849f2e17a37a17206731f5710" />
<meta name="analytics-location" content="/&lt;user-name&gt;/&lt;repo-name&gt;/blob/show" data-pjax-transient="true" />
  ...
  <meta class="js-ga-set" name="dimension1" content="Logged In">
    ...
    <meta name="user-login" content="oilenrock07">

      <meta name="expected-hostname" content="github.com">
    <meta name="js-proxy-site-detection-payload" content="YTQ2Zjk2NWE5ZDdlZmQ2ZDhiOWY5YmRiMTgzNjVhOGM0ZDEwNjc1MzcwNjViY2ZiNDY4Yjc1Njc3OWY0MzhiZnx7InJlbW90ZV9hZGRyZXNzIjoiMTI0LjYuMTU3LjgzIiwicmVxdWVzdF9pZCI6IjVGNTk6MjA2MjoyNkYxMTBDOjNBQUI4QTA6NUIwQkQyNzYiLCJ0aW1lc3RhbXAiOjE1Mjc1MDE0MzcsImhvc3QiOiJnaXRodWIuY29tIn0=">
  ...
  <meta name="html-safe-nonce" content="7302e57895b273f2aa5ef6bd12ab5bb989cfc85d">
    ...
    <!-- '"` --><!-- </textarea></xmp> --></option></form><form class="js-site-search-form" data-scope-type="Repository" data-scope-id="1041356" data-scoped-search-url="/SteveSanderson/knockout.mapping/search" data-unscoped-search-url="/search" action="/SteveSanderson/knockout.mapping/search" accept-charset="UTF-8" method="get"><input name="utf8" type="hidden" value="&#x2713;" />
      <label class="form-control header-search-wrapper header-search-wrapper-jump-to position-relative d-flex flex-justify-between flex-items-center js-chromeless-input-container">
        <input type="text"
          ...
          data-jump-to-suggestions-path="/_graphql/GetSuggestedNavigationDestinations#csrf-token=fiktK0DIZ8JdjrRnVzN+zOUWY3gakqrjIbrxydHqGtQrbYNl7jOrhn3Q2fRq7DV1HFabmf79919s/9bl6NEBWA=="
          spellcheck="false"
          autocomplete="off"
          autocapitalize="off"
          >
...
<ul class="user-nav d-flex flex-items-center list-style-none" id="user-links">
  <li class="dropdown js-menu-container">
    ...
    <a aria-label="You have unread notifications" class="notification-indicator tooltipped tooltipped-s  js-socket-channel js-notification-indicator" data-hotkey="g n" data-ga-click="Header, go to notifications, icon:unread" data-channel="notification-changed:625367" href="/notifications">
...
<a class="dropdown-item" href="https://gist.github.com/" data-ga-click="Header, create new gist">
  ...
  <li class="dropdown js-menu-container">
    ...
    <details class="details-expanded details-reset js-dropdown-details d-flex pl-2 flex-items-center">
      <summary class="HeaderNavlink name mt-1"
        ...
        <img alt="@oilenrock07" class="avatar float-left mr-1" src="https://avatars1.githubusercontent.com/u/625367?s=40&amp;v=4" height="20" width="20">
        <span class="dropdown-caret"></span>
      </summary>

      <ul class="dropdown-menu dropdown-menu-sw">
        <li class="dropdown-header header-nav-current-user css-truncate">
          Signed in as <strong class="css-truncate-target">oilenrock07</strong>
        </li>

        <li class="dropdown-divider"></li>

        <li><a class="dropdown-item" href="/oilenrock07" data-ga-click="Header, go to profile, text:your profile">
          Your profile
        </a></li>
        <li><a class="dropdown-item" href="/oilenrock07?tab=stars" data-ga-click="Header, go to starred repos, text:your stars">
          Your stars
        </a></li>
        ...
        <li><!-- '"` --><!-- </textarea></xmp> --></option></form><form class="logout-form" action="/logout" accept-charset="UTF-8" method="post"><input name="utf8" type="hidden" value="&#x2713;" /><input type="hidden" name="authenticity_token" value="SwiXJseXu0ZsbJEuDc5gsG4r/YqPbn+yuovnZyOo33f2i2FcLEIVQ45XsivZSaVmDWbbKwKN9iVSiBABMxM3Sw==" />
        ...
        <!-- '"` --><!-- </textarea></xmp> --></option></form><form class="sr-only right-0" action="/logout" accept-charset="UTF-8" method="post"><input name="utf8" type="hidden" value="&#x2713;" /><input type="hidden" name="authenticity_token" value="qNe7bi+NpbsaB/ZPDrFkkIySev2C04YWn6uDl/JK1gkVVE0UxFgLvvg81UraNqFG799cXA8wD4F3qHTx4vE+NQ==" />
          <button type="submit" class="dropdown-item dropdown-signout" data-ga-click="Header, sign out, icon:logout">
            Sign out
          </button>
</form>      </div>
  ...
  <li>
        <!-- '"` --><!-- </textarea></xmp> --></option></form><form data-autosubmit="true" data-remote="true" class="js-social-container" action="/notifications/subscribe" accept-charset="UTF-8" method="post"><input name="utf8" type="hidden" value="&#x2713;" /><input type="hidden" name="authenticity_token" value="/7cBC93sz1MaSSK3NewV+5ybJdq8QYV+BESvbBbu6Q1LNIpzYhfHF97tZG+L0NjaH+LjjDjmuutIe6ftmQr65g==" />      <input type="hidden" name="repository_id" id="repository_id" value="1041356" class="form-control" />
  ...
  <div class="js-toggler-container js-social-container starring-container ">
    <!-- '"` --><!-- </textarea></xmp> --></option></form><form class="starred js-social-form" action="/SteveSanderson/knockout.mapping/unstar" accept-charset="UTF-8" method="post"><input name="utf8" type="hidden" value="&#x2713;" /><input type="hidden" name="authenticity_token" value="WqCNEu1PTiNxnJBxK6QJ37MX1nOF7OcQTmAaDXrM11pIIrlYairxSbnE9c///6zGM40sHCHSrVkUPwOO7HHfzg==" />
    ...
    <!-- '"` --><!-- </textarea></xmp> --></option></form><form class="unstarred js-social-form" action="/SteveSanderson/knockout.mapping/star" accept-charset="UTF-8" method="post"><input name="utf8" type="hidden" value="&#x2713;" /><input type="hidden" name="authenticity_token" value="Hhic10yv7vgGc3mKOXzwt7qCuCZ0C1UHfJD1O7uqcr2GtKQM/WRJQuSRVaT5dk4TceDHcjb1ZaZtB6+ql4hG3g==" />
      <input type="hidden" name="context" value="repository"></input>
      <button
        type="submit"
        class="btn btn-sm btn-with-count js-toggler-target"
  ...
  <li>
          <!-- '"` --><!-- </textarea></xmp> --></option></form><form class="btn-with-count" action="/SteveSanderson/knockout.mapping/fork" accept-charset="UTF-8" method="post"><input name="utf8" type="hidden" value="&#x2713;" /><input type="hidden" name="authenticity_token" value="dZ+7Fd+gcKilxj+3IZqcHV5reYE7luXkEPeOjib/z/e0tgD9wx0BC53s0bYRnhXe5G5I1J6tYraDPxhcXirRXw==" />
            <button
                type="submit"
    ...
    <a href="/SteveSanderson/knockout.mapping/network" class="social-count"
       aria-label="788 users forked this repository">
      788
    </a>
  </li>
</ul>
...
<nav class="reponav js-repo-nav js-sidenav-container-pjax container"
  ...
  <span itemscope itemtype="http://schema.org/ListItem" itemprop="itemListElement">
    ...
    <a class="js-selected-navigation-item reponav-item" data-hotkey="g w" data-selected-links="repo_wiki /SteveSanderson/knockout.mapping/wiki" href="/SteveSanderson/knockout.mapping/wiki">
...
<div class="select-menu branch-select-menu js-menu-container js-select-menu float-left">
  ...
  <include-fragment src="/SteveSanderson/knockout.mapping/contributors/master/build/output/knockout.mapping-latest.js" class="commit-tease">
    <div>
    ...
    <div class="BtnGroup">
      ...
      <a rel="nofollow" class="btn btn-sm BtnGroup-item" href="/SteveSanderson/knockout.mapping/commits/master/build/output/knockout.mapping-latest.js">History</a>
        ...
        <a class="btn-octicon tooltipped tooltipped-nw"
          ...
          <!-- '"` --><!-- </textarea></xmp> --></option></form><form class="inline-form js-update-url-with-hash" action="/SteveSanderson/knockout.mapping/edit/master/build/output/knockout.mapping-latest.js" accept-charset="UTF-8" method="post"><input name="utf8" type="hidden" value="&#x2713;" /><input type="hidden" name="authenticity_token" value="jqmcbllHKGZ/g8F4Mn/vMtc8I4A4CDxxoFcaV7p6iOs5m3PiJnL5TBQd+a9Xzqh7fluaBX4ZKyDiHmOqzHz1wg==" />
            <button class="btn-octicon tooltipped tooltipped-nw" type="submit"
              aria-label="Fork this project and edit the file" data-hotkey="e" data-disable-with>
              <svg class="octicon octicon-pencil" viewBox="0 0 14 16" version="1.1" width="14" height="16" aria-hidden="true"><path fill-rule="evenodd" d="M0 12v3h3l8-8-3-3-8 8zm3 2H1v-2h1v1h1v1zm10.3-9.3L12 6 9 3l1.3-1.3a.996.996 0 0 1 1.41 0l1.59 1.59c.39.39.39 1.02 0 1.41z"/></svg>
            </button>
</form>
        <!-- '"` --><!-- </textarea></xmp> --></option></form><form class="inline-form" action="/SteveSanderson/knockout.mapping/delete/master/build/output/knockout.mapping-latest.js" accept-charset="UTF-8" method="post"><input name="utf8" type="hidden" value="&#x2713;" /><input type="hidden" name="authenticity_token" value="5Ls4zowVu6sleOIU5jL19uK92fasdc+6JC0aDWHLU09VOekx0hJnQKrwlXGoDApemdqDVdEmOdafgl+OVVu8Fw==" />
  ...
  <div class="BlobToolbar position-absolute js-file-line-actions dropdown js-menu-container js-select-menu d-none" aria-hidden="true">
    ...
    <div class="dropdown-menu-content js-menu-content" id="inline-file-actions">
      <ul class="BlobToolbar-dropdown dropdown-menu dropdown-menu-se mt-2">
        ...
        <li><a class="dropdown-item js-update-url-with-hash" id="js-view-git-blame" href="/SteveSanderson/knockout.mapping/blame/92f2649c61bdad2da3406811518f80387a1f6b57/build/output/knockout.mapping-latest.js">View git blame</a></li>
          <li><a class="dropdown-item" id="js-new-issue" href="/SteveSanderson/knockout.mapping/issues/new">Open new issue</a></li>
      </ul>
    </div>
  </div>
...
<div class="footer container-lg px-3" role="contentinfo">
  <div class="position-relative d-flex flex-justify-between pt-6 pb-2 mt-6 f6 text-gray border-top border-gray-light ">
    <ul class="list-style-none d-flex flex-wrap ">
      <li class="mr-3">&copy; 2018 <span title="0.43411s from unicorn-2729460630-r16tr">GitHub</span>, Inc.</li>
